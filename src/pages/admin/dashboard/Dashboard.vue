<template>
  <div>
    ...
    <div class="tabs-container">
      ...
      <div v-if="value === 'Investments'" class="tab-content" outlined>
        <InvestmentsSentiment />
      </div>
...
const tabs = ['Sentiment', 'Investments', 'Shiller', 'Metals', 'UK Rates', 'Money', 'Oil/Gas', 'Samuel Benner']
