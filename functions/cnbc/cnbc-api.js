...
export const getHistoricalValuesImpl = async (req, res) => {
  try {
    // Parse request body
    ...
    const graphqlUrl = `https://webql-redesign.cnbcfm.com/graphql?operationName=getQuoteChartData&variables=${encodedVariables}&extensions=${encodedExtensions}`;
